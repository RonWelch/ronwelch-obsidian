...
created: 2026-07-20
description: Everyone is worried about Chinese models, but the frontier labs will be fine; we need to enable open U.S. alternatives.
tags:
  - clippings
...
- Memory efficiency: Architectural choices (e.g. MLA in Kimi K3) reduce KV cache requirements, allowing more concurrent requests and better GPU utilization.
