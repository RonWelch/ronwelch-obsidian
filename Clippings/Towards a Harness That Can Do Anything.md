---
title: arda tasci
source: https://eardatasci.github.io/c/ambiance/index.html?utm_source=tldrdev
author:
published:
created: 2026-07-16
description:
...
![Harvey Specter: I don't play the odds, I play the man.](https://eardatasci.github.io/c/ambiance/harvey.jpg)
...
Ambiance is a work in progress, but you can try it today at [whitematterlabs.ai](https://whitematterlabs.ai/), or skip straight to:

```
curl -fsSL https://raw.githubusercontent.com/whitematterlabs/ambiance/main/install.sh | sh
```

*PS: Do projects like this interest you? Are you working on projects like this yourself? You should totally check out the [Recurse Center](https://www.recurse.com/), which is where I started building this out!*
